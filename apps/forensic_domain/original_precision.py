...
class ForensicGateLayer:
    ...
    def validate_existence(events: list, rule: ForensicRule):
        ...
        # [UPDATE]: Added leadership roles and oversight keywords for administrative rule bridging.
        ...
        for e in events:
            ...
            for target in targets:
                ...
                # B. Role & Scope-Aware Fuzzy Match (Scalable Fix)
                else:
                    ...
                    # Bridge: If Universal/Role -> Local/Artifact detected, drop to 15%.
                    threshold = 0.4
