    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wallet_address', models.CharField(blank=True, help_text='Lisk wallet address or identity reference', max_length=120, null=True)),
                ('practicing_certificate', models.CharField(blank=True, help_text='Lawyers only', max_length=255, null=True)),
